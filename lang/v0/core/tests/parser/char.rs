...
mod tests_char {
    ...
    use celma_v0_core::parser::char::alpha;
    use celma_v0_core::parser::char::alpha_lower;
    use celma_v0_core::parser::char::alpha_upper;
    use celma_v0_core::parser::char::digit;
    use celma_v0_core::parser::char::not_char;
